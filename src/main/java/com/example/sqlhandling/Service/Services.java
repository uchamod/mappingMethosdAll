...
public class Services {
    ...
    public Dto getDataById(int id){
        UserDetail detail=repo.getUserById(id);
        return modelmapper.map(detail,Dto.class);
    }
    public Dto getDataByIdandAddress(int id,String address){
        UserDetail detail=repo.getUserByIdandAddress(id,address);
        return modelmapper.map(detail,Dto.class);
    }
