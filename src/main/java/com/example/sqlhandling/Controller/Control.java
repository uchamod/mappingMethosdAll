...
public class Control {
    ...
    public Dto getById(@PathVariable int userId){
        return service.getDataById(userId);
    }

    @GetMapping("/getUserByIdandAddress/{userId}/{address}")
    public Dto getById(@PathVariable int userId,@PathVariable String address){
        System.out.println("UserId"+userId+" UserAddress"+address);
        return service.getDataByIdandAddress(userId,address);
    }
}
